        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-teal-600">
                Contactez-Nous
              </h2>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 lg:p-10">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full py-4 bg-white border-2 border-teal-600 text-teal-600 font-semibold rounded-full hover:bg-teal-600 hover:text-white transition-all duration-300 text-lg"
              >
                Envoyer le message
              </button>
            </div>
